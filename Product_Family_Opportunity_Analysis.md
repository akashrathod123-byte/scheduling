# Product-Family Opportunities — Sized with Reasons You Can Check
...
| **2** | Genuinely new, small (under ~250) | 9,115 | 74% |
| **3** | Niche, real size+material depth (about 250-500) | 268 | 2% |
| **4** | Deep family / system (about 500-5,000) | 55 | 0% |
...
- **Duct Hose Kits, Wrap and Hangers** — about **~150** in the world. duct hose kits, duct wrap, duct hangers, wire-rope suspension brackets, damper actuator mounts, damper switch mounts, damper shaft extensions, damper bearings, duct heaters, heat-cable mounts: several duct sizes x parts = ~150. *Check:* Nordfab.
...
- **Subsea Sonar Sounders and Acoustic Devices** — about **~120** in the world. echosounders + ADCP + transponders + modems + hydrophones + releases + air guns, several each = ~100+. *Check:* Teledyne Marine.
...
- **Semiconductor and Laser Crystal Wafers** — about **~250** in the world. about 12 crystal materials x 5 sizes x 4 orientations = ~250. *Check:* MTI Corporation.
- **Spectrometers, flame emission, ion analyzers, particle size, moisture, fluorometers, bolometers, ellipsometers** — about **100-500** in the world. many analyzer types x model tiers = ~400. *Check:* PerkinElmer.
- **Structural, Tilt-Pad, Jewel, Isolators, Protectors, Retainers, Needle Rollers** — about **~250** in the world. about 8 bearing types x many sizes = ~250. *Check:* Kingsbury.
- **Pump Monitoring and Control Electronics** — about **~250** in the world. meters, controllers, data loggers, modems, monitoring systems, starters, speed/soft-start controls: 8 functions x several sizes/channels = ~250. *Check:* Xylem.

### Bucket 3 — grouped (Domain › Group › Family)

**Lab/Optics & Scientific** — 51 opportunities
...
- *Semiconductor Crystals* › **Semiconductor and Laser Crystal Wafers** — ~250. about 12 crystal materials x 5 sizes x 4 orientations = ~250. *Check:* MTI Corporation.
- *Laser Components* › **Laser Optics and Active Components** — ~250. laser crystals, laser glass, optical isolators, Pockels cells, nonlinear crystals, Raman crystals: several media x wavelengths x sizes = ~250. *Check:* Thorlabs.
...
- *Optical Windows* › **Optical Windows (all spectral ranges)** — ~250. windows for visible, UV, terahertz, hydrophobic, UV/IR ranges: several substrates x sizes x coatings = ~250. *Check:* Edmund Optics.

**Electrical & Electronic** — 46 opportunities
...
- *Circuit Board Chips* › **Bluetooth Clock Controller and Driver Chips** — ~250. bluetooth + RTC + hot-swap + peripheral + RAID + transmission chips, many part numbers each = a few hundred. *Check:* Texas Instruments.
- *Power Distribution Switching* › **Switchgear Switchboards Busways and MCCs** — ~250. switchgear + switchboards + busways + MCC + metering, many voltage/amp ratings = a few hundred. *Check:* Eaton.
- *Connectors* › **Card and Circuit Board Connectors** — 200-500. card connectors, circuit board connectors, insulation-piercing connectors: many pin counts x pitches x types = a few hundred. *Check:* Molex.
- *Connectors* › **Circuit board mezzanine and backplane connectors** — 100-500. many pin counts x heights x speeds = ~400. *Check:* Samtec.
- *Connectors* › **Electrical connector backshells** — 100-500. many shell sizes x styles x mil-spec or not = ~400. *Check:* Amphenol.
- *Enclosures* › **Electrical enclosure parts (sides, roofs, door interlocks, weather hoods, seismic kits)** — 100-500. many enclosure sizes x part types = ~400. *Check:* Rittal.

**Test/Measurement & Inspection** — 36 opportunities
...
- *Lab analyzers* › **Spectrometers, flame emission, ion analyzers, particle size, moisture, fluorometers, bolometers, ellipsometers** — 100-500. many analyzer types x model tiers = ~400. *Check:* PerkinElmer.
- *Test chambers* › **Environmental test chambers (temperature, vibration, photostability, thermal gravimetric, curemeters)** — 100-500. several chamber sizes x test types x configs = ~400. *Check:* Thermotron.
...
**Plumbing/Pipe & Fluid Handling** — 26 opportunities
...
**Raw Materials & Stock** — 23 opportunities
...
- *Precious Metals* › **Silver and Platinum Group** — 200-500. silver, scandium dup removed, platinum-related forms: a few metals x many forms x grain sizes = a few hundred. *Check:* American Elements.

**Power Transmission & Motion** — 19 opportunities
...
- *Suspension* › **Anti-Roll (Sway) Bars** — ~300. hundreds of vehicle models x front/rear = ~300. *Check:* Hellwig.
- *Gearmotors* › **Servo Gearmotors** — 200-500. many gearbox types x ratios x sizes = a couple hundred. *Check:* SEW-Eurodrive.

**HVAC/Thermal & Process** — 17 opportunities
...
- *Air Handling* › **Fan Coil Units** — ~300. about 10 capacities x 3 cabinet styles x a few coil rows x 2 voltages = ~300. *Check:* Daikin.

**Industrial & Specialty Equipment** — 12 opportunities
...
**Cutting/Machining & Metalworking** — 10 opportunities
- *Mining and Construction Tools* › **Mining, Foundation, and Road Cutting Tools** — ~300. picks, bits, crushers x many ground types x many sizes = ~300. *Check:* Kennametal.
- *Milling Cutters* › **Side Mills and Angle Cutters** — ~300. side mills + angle cutters, many diameters and angles each = a few hundred. *Check:* Sandvik Coromant.
- *Stamping Die Components* › **Slug Ejector Punches and Gas Die Springs** — ~250. ejector punches + gas die springs, many sizes/forces each = a few hundred. *Check:* Misumi.
- *Gear Cutting* › **Gear Hobs** — 100-500. about 30 modules x several pressure angles x materials = a few hundred hobs. *Check:* Gleason.

**Safety/PPE & Facility** — 9 opportunities
- *Railing & Framing Safety* › **Slip-On Framing Posts Gates and Panels** — ~250. posts + gates + hinges + latches + infill panels + toeboard + adj brackets, many sizes each = a few hundred. *Check:* Kee Safety.
- *Mobility* › **Mobility Aids** — 200-400. walkers, canes, wheelchairs x many sizes x styles = ~300. *Check:* verify.

**Fasteners & Hardware** — 4 opportunities
...
**Material Handling & Storage** — 4 opportunities
...
- *Plant & Garden* › **Plant Pots** — ~300. about 15 sizes x 6 materials x 4 colors = ~300. *Check:* The HC Companies.
- *Wire Shelving* › **Wire Board Accessories** — 200-400. hooks, brackets, shelves, baskets x many sizes x coatings = ~300. *Check:* Akro-Mils.

**Automation/Robotics & Controls** — 3 opportunities
- *Sensors* › **Photoelectric and Occupancy Sensors** — ~280. merges photoelectric, occupancy, fan motion sensors; modes x ranges = ~280. *Check:* Banner Engineering.
...
**Welding/Soldering & Joining** — 1 opportunities
...
**55 opportunities (0%); 7 families.** Full list with the math + a company to check:
...
**Automation/Robotics & Controls** — 11 opportunities
- *Robotics framing* › **GoBilda robot building parts (rails, mounts, wheels, shafts, lead screws, belt clamps, fasteners, kits, beams, channels, odometry)** — 500-1500. many part types x sizes x metals = hundreds; a whole robot building system. *Check:* GoBilda.
...
**Industrial & Specialty Equipment** — 1 opportunities
- *Medical* › **Bone Screws** — 5,000+. many diameters x lengths x thread types x materials = thousands. *Check:* DePuy Synthes.

**Electrical & Electronic** — 1 opportunities
- *Computer Hardware* › **Computer Build Components** — 5,000+. thousands of CPUs, GPUs, RAM, motherboards x many models = thousands. *Check:* Newegg.

## Where the depth is — Domain × bucket
| Domain | Opps | B1 | B2 | B3 | B4 | B5 |
|---|--:|--:|--:|--:|--:|--:|
| Electrical & Electronic | 1523 | 486 | 987 | 47 | 2 | 1 |
| Test/Measurement & Inspection | 1485 | 251 | 1176 | 36 | 22 | 0 |
| Material Handling & Storage | 1043 | 304 | 735 | 4 | 0 | 0 |
| Industrial & Specialty Equipment | 886 | 159 | 713 | 12 | 1 | 1 |
| Safety/PPE & Facility | 834 | 190 | 635 | 9 | 0 | 0 |
| Lab/Optics & Scientific | 817 | 119 | 638 | 51 | 6 | 3 |
| Cutting/Machining & Metalworking | 723 | 178 | 535 | 10 | 0 | 0 |
| Plumbing/Pipe & Fluid Handling | 693 | 164 | 503 | 26 | 0 | 0 |
| HVAC/Thermal & Process | 638 | 112 | 509 | 17 | 0 | 0 |
| Hand & Power Tools | 560 | 215 | 345 | 0 | 0 | 0 |
| Cleaning/Chemicals & Lubrication | 539 | 139 | 400 | 0 | 0 | 0 |
| Automation/Robotics & Controls | 510 | 83 | 413 | 3 | 11 | 0 |
| Power Transmission & Motion | 510 | 182 | 308 | 19 | 0 | 1 |
| Raw Materials & Stock | 300 | 4 | 260 | 23 | 13 | 0 |
| Welding/Soldering & Joining | 284 | 73 | 210 | 1 | 0 | 0 |
| Fasteners & Hardware | 267 | 80 | 183 | 4 | 0 | 0 |
| Abrasives & Surface Finishing | 129 | 34 | 95 | 0 | 0 | 0 |
| Automotive | 21 | 1 | 19 | 1 | 0 | 0 |
