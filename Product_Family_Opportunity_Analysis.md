...
- *Vacuum Process Instruments* › **Vacuum Gauges Transmitters and Controllers** — ~150. vacuum + pressure transmitters + controllers (x2) + diff switches + RGA, many ranges each = ~100-200. *Check:* Pfeiffer Vacuum.
...
- *Lab Imaging & Analysis* › **Lab Spectrometers and Chemical Analyzers** — ~150. FTIR + GC + GC-MS + RGA + emission + OCT + gradient pumps, each several models = ~100-200. *Check:* Thermo Fisher Scientific.
...
- *Sensors - Motion & Position* › **Inertial Impact and Angle Sensors** — ~120. inertial switches + impact + multi-axis + angle transmitters + condition sensors, several each = ~100+. *Check:* TE Connectivity.
...
**Abrasives & Surface Finishing** — 7 opportunities
- *Polishing & Deburring* › **Polishing Belts and Tube Brushes** — ~120. polishing belts + threaded tube brushes + angle grinder tube brushes + brush kits, many sizes each = ~100+. *Check:* 3M.
